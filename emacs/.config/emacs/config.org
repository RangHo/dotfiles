...
#+begin_src emacs-lisp
  ...
  (defun rangho/set-default-font ()
    ...
    (let ((fixed-font (rangho/find-first-available-font rangho/fixed-font-alist nil))
      ...
      ;; Default fontset
      (rangho/set-fontset-fonts t '(hangul kana han symbol emoji) rangho/fixed-font-alist)
      ;; Fixed-pitch fontset
      (create-fontset-from-fontset-spec
       (font-xlfd-name
        (font-spec :name fixed-font
                   :registry "fontset-fixed")))
      (rangho/set-fontset-fonts "fontset-fixed" '(hangul kana han symbol emoji) rangho/fixed-font-alist)
      ;; Variable-pitch fontset
      (create-fontset-from-fontset-spec
       (font-xlfd-name
        (font-spec :name variable-font
                   :registry "fontset-variable")))
      (rangho/set-fontset-fonts "fontset-variable" '(hangul kana han symbol emoji) rangho/variable-font-alist)
         ...
         (lighten-color-by-value
          (lambda (color value)
            (cons (intern (concat
                  ...
                  (color-lighten-hex (cdr color) value))))
...
#+begin_src emacs-lisp
  ...
  (let-alist rangho/color-matrix-alist
    (custom-set-faces
     ...
     `(hl-line             ((t (:background ,.color/background+15 :extend t))))
     ...
     `(mode-line           ((t (:foreground ,.color/background-20
                                :background ,.color/foreground+20
                                :box (:line-width 3 :color ,.color/foreground+10 :style nil)))))
     `(mode-line-inactive  ((t (:foreground ,.color/foreground-20
     ...
     ;; Org
     `(org-block                 ((t (:background ,.color/background+10))))
...
#+begin_src emacs-lisp
  ...
  (use-package rust-mode
    :hook ((rust-mode . eglot-ensure)
           (rust-mode . rangho/add-rust-mode-before-save-hook)))
#+end_src
