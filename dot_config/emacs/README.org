...
#+begin_src emacs-lisp
  (use-package dashboard
    ...
    (dashboard-startup-banner (expand-file-name "images/gnu-emacs.png" user-emacs-directory))
...
#+begin_src emacs-lisp
  (defconst rangho/julia-language-server-project
    (expand-file-name
     (locate-user-emacs-file (file-name-concat "language-servers" "julia"))))

  (defconst rangho/julia-language-server-script
    (expand-file-name
     (locate-user-emacs-file (file-name-concat "scripts" "eglot-julia"))))
  ...
  (use-package copilot
    ...
    (copilot-install-dir (expand-file-name
                          (locate-user-emacs-file
                           (file-name-concat "language-servers" "copilot")))))
#+end_src
