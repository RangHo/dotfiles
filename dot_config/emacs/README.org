...
*** Text Mode Limited to Fill Column
...
#+begin_src emacs-lisp
  ...
  (use-package org-node
    ...
    :init
    ;; The :bind-keymap keyword cannot bind a keymap to another map yet.
...
#+begin_src emacs-lisp
  ...
  (let-alist rangho--color-matrix-alist
    (custom-set-faces
     ...
     `(fringe                     ((t (:background ,.color--background))))
     ...
     `(mode-line                  ((t (:foreground ,.color--background-10 :background ,.color--foreground+10 :box (:line-width 3 :color ,.color--foreground+10 :style nil)))))
     `(mode-line-inactive         ((t (:foreground ,.color--foreground-10 :background ,.color--background+10 :box (:line-width 3 :color ,.color--background+10 :style nil)))))
     ...
     `(window-divider             ((t (:foreground ,.color--background+10))))
     `(window-divider-first-pixel ((t (:foreground ,.color--background+10))))
     `(window-divider-last-pixel  ((t (:foreground ,.color--background+10))))
     ...
     `(org-document-title        ((t (:foreground ,.color--intense-red))))
     ...
     `(org-warning               ((t (:foreground ,.color--yellow))))
