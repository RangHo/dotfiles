...
#+begin_src emacs-lisp
  ...
  (let-alist rangho/color-matrix-alist
    (custom-set-faces
     ...
     `(window-divider             ((t (:foreground ,.color/background))))
     `(window-divider-first-pixel ((t (:foreground ,.color/background))))
     `(window-divider-last-pixel  ((t (:foreground ,.color/background))))
