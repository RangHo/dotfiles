...
OCaml has its own package manager called OPAM.
It allows installing multiple versions of compilers, à la Python's ~venv~.
There is a minor mode for Emacs to use those switches.

#+begin_src emacs-lisp
  (use-package opam-switch-mode
    :hook ((coq-mode . opam-switch-mode)
           (tuareg-mode . opam-switch-mode)
           (proof-shell-mode . opam-switch-mode)))
#+end_src
