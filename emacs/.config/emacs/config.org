...
These are defined with ~defvar~ because I might want to change this depending on the project I am working on.
...
#+begin_src emacs-lisp
  ...
  (defconst rangho/fixed-font-alist
    '((nil "hesalche" "semteulche" "Noto Sans Mono")
      (hangul "hesalche" "semteulche" "Noto Sans Mono CJK KR")
...
#+begin_notes
There is a problem in CJK font rendering where creating 
#+end_notes
...
#+begin_src emacs-lisp
  ...
  (defun rangho/set-fontset-fonts (fontset charsets alist)
    "Set fonts for CHARSETS in FONTSET using ALIST."
    (dolist (charset charsets)
      (dolist (font (rangho/find-font-specs alist charset))
  ...
  (defun rangho/set-default-font ()
    ...
    (let ((fixed-font (rangho/find-first-available-font rangho/fixed-font-alist nil))
      ...
      ;; Default fontset
      (rangho/set-fontset-fonts t '(hangul kana han emoji) rangho/fixed-font-alist)
      ;; Fixed-pitch fontset
      (create-fontset-from-fontset-spec
       (font-xlfd-name
        (font-spec :name fixed-font
                   :registry "fontset-fixed")))
      (rangho/set-fontset-fonts "fontset-fixed" '(hangul kana han emoji) rangho/fixed-font-alist)
      ;; Variable-pitch fontset
      (create-fontset-from-fontset-spec
       (font-xlfd-name
        (font-spec :name variable-font
                   :registry "fontset-variable")))
      (rangho/set-fontset-fonts "fontset-variable" '(hangul kana han emoji) rangho/variable-font-alist)
...
- ~electric-quote-mode~ :: Replace =`= and ='= with opening and closing quotes, respectively.
...
#+begin_src emacs-lisp
  (use-package org
    ...
    :bind (("C-c a" . org-agenda)
           ("C-c t" . org-capture))
    :custom
    (org-directory (file-truename "~/Documents/Notes"))
...
#+begin_src emacs-lisp
  (defconst rangho/web-mode-server-program-alist
  ...
  (defun rangho/web-mode-contact (_)
    ...
    (alist-get web-mode-engine rangho/web-mode-server-program-alist
  ...
  (use-package web-mode
    ...
    :config
    (add-to-list 'eglot-server-programs '(web-mode . rangho/web-mode-contact)))
#+end_src
