...
#+begin_src emacs-lisp
  (use-package dashboard
    ...
    (dashboard-startup-banner (expand-file-name "image/gnu-emacs.png" user-emacs-directory))
...
#+begin_src emacs-lisp
  (use-package treemacs
    ...
    (treemacs-persist-file (expand-file-name
                            (locate-user-emacs-file (file-name-concat "treemacs" "persist"))))
    (treemacs-last-error-persist-file (expand-file-name
                                  (locate-user-emacs-file (file-name-concat "treemacs" "persist-at-last-error"))))
    :config
...
#+begin_src emacs-lisp
  (use-package yasnippet
    ...
    (yas-snippet-dirs (list (expand-file-name
                             (locate-user-emacs-file "snippet"))))
    :config
    (yas-global-mode +1))
...
#+begin_src emacs-lisp
  (defconst rangho/julia-language-server-project
    (expand-file-name
     (locate-user-emacs-file (file-name-concat "language-server" "julia"))))

  (defconst rangho/julia-language-server-script
    (expand-file-name
     (locate-user-emacs-file (file-name-concat "script" "eglot-julia"))))
...
** Why3
Why3 is a deductive software verification platform.
...
** Easy Draw
~el-easydraw~ is a drawing tool that runs inside Emacs.
...
#+begin_src emacs-lisp
  (use-package copilot
    ...
    :hook (prog-mode)
    :custom
    (copilot-install-dir (expand-file-name
                          (locate-user-emacs-file
                           (file-name-concat "language-server" "copilot")))))
#+end_src
